                ...
                <div className='flex flex-col w-full'>
                    ...
                    <div className="filter-container p-4 sticky top-0 z-50 bg-white">
                        <select
                            ...
                            className="w-60 border border-gray-300 shadow-sm focus:outline-none focus:boder-2 focus:border-cor4 rounded p-1"
                        >
                                ...
                                refeicaoEscola.meals.map((meal) => (
                                    meal.ingredientes.map((ingrediente) => (
                                        <React.Fragment key={ingrediente._id}>
                                            ...
                                            <div className="bg-white p-2 rounded-md shadow h-fit">{ingrediente.quantidade}</div>
