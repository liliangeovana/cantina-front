                ...
                <div className="flex flex-col bg-gray-100">
                    ...
                    <div className="h-svh flex flex-col justify-between w-56 bg-white overflow-hidden">
                        <ul className="flex flex-col py-1">
                            ...
                            <li>
                                <a href="../escola/cadastrar-ingredientes/" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
                                    <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i className="bx bx-plus"></i></span>
                                    <span className="text-sm font-medium">Cadastrar ingredientes</span>
                                </a>
                            </li>
                            <li></li>
                            ...
                            <li>
                                <a href="#" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
                                    ...
                                    <span className="text-sm font-medium">Uso de insumos</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
